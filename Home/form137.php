    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="stats-card total">
                ...
                <div class="stats-number" id="totalRecords"><?php echo $total_records; ?></div>
        ...
        <div class="col-md-3">
            <div class="stats-card male">
                ...
                <div class="stats-number" id="maleStudents"><?php echo $male_students; ?></div>
        ...
        <div class="col-md-3">
            <div class="stats-card female">
                ...
                <div class="stats-number" id="femaleStudents"><?php echo $female_students; ?></div>
        ...
        <div class="col-md-3">
            <div class="stats-card high-school">
                ...
                <div class="stats-number" id="highSchoolCompleters"><?php echo $high_school_completers; ?></div>
...
$(document).ready(function() {
    ...
    $('#genderFilter').on('change', function() {
        ...
        if(searchTerm === ''){
            table
            .column(2) // Gender column
            .search(searchTerm)
            .draw();
        }else{
            table
            .column(2) // Gender column
            .search('^' + searchTerm + '$', true, false) // Exact match using regex
            .draw();
...
function fetchFilteredData() {
    ...
    const gradeSection = $('#gradeSectionFilter').val();
    const gender = $('#genderFilter').val();

    // Send AJAX request to fetch updated data
    $.ajax({
        url: 'fetch_formData.php',
        type: 'POST',
        data: {
        ...
        success: function (response) {
            ...
            // Update statistics
            $('#maleStudents').text(data.male_students);
            $('#femaleStudents').text(data.female_students);
            $('#highSchoolCompleters').text(data.high_school_completers);
