...
<div class="container">
    ...
    <form action="adminprocesschangepassword.php" method="post" id="changePasswordForm">
        ...
        <div class="btn-container">
            <button type="button" class="cancel-btn" onclick="window.location.href='adminhomepage.php'">Cancel</button>
